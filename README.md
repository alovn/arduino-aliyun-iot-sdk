...
原代码拷贝自<https://github.com/yu-tou/arduino-aliyun-iot-sdk>，本仓库对代码做了略微调整，适用于阿里云物联网平台公共实例，企业版实例未测试。
...
#define IOT_INSTANCE_ID "xxxxxxxx"
...
void setup()
{
    ...
    AliyunIoTSDK::begin(espClient, PRODUCT_KEY, DEVICE_NAME, DEVICE_SECRET, IOT_INSTANCE_ID);
